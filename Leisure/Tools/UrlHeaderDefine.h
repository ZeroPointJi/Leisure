...
// 阅读模块请求地址
#define READHOMELIST_URL     @"http://api2.pianke.me/read/columns" //阅读首页列表
#define READDETAILLIST_URL   @"http://api2.pianke.me/read/columns_detail"  // 列表详情

// 良品模块
#define SHOPLIST_URL  @"http://api2.pianke.me/pub/shop"  // 良品首页列表
#define SHOPINFO_URL  @"http://api2.pianke.me/group/posts_info" //良品详情
